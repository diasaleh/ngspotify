...
var ArtistComponent = (function () {
    function ArtistComponent(_spotifyServive, _route) {
        this._spotifyServive = _spotifyServive;
        this._route = _route;
    }
    ArtistComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._route.params
            .map(function (parems) { return parems['id']; })
            .subscribe(function (id) {
            _this._spotifyServive.getArtist(id).subscribe(function (artist) {
                _this.artist = artist;
            });
            _this._spotifyServive.getAlbums(id).subscribe(function (albums) {
